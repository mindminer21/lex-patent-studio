    ...
    <>
      ...
      {termsPending ? (
        <div className="wp-boundary-banner wp-banner-danger">
          ...
          <Link href="/app/terms">Review and accept</Link>
        </div>
      ) : (
        <div className="wp-boundary-banner">
      ...
      <div className="wp-grid cols-3">
        ...
        <div className="wp-card">
          ...
          <p>
            ...
            run. <Link href="/app/billing">Billing</Link>
          </p>
        </div>
        <div className="wp-card">
      ...
      <div className="wp-card" style={{ marginTop: 22 }}>
        <div className="wp-topbar" style={{ marginBottom: 10 }}>
          ...
          <Link className="button venture-button button-small" href="/app/inventions/new">
        ...
        {factSummaries.length === 0 ? (
          <div className="wp-empty">
            ...
            <Link className="button venture-button" href="/app/inventions/new">
          ...
          <table className="wp-table">
            ...
            <tbody>
              {factSummaries.map(({ invention, factCount, unresolved }) => (
                <tr key={invention.id}>
                  <td>
                    <Link href={`/app/inventions/${invention.id}`}>{invention.title}</Link>{" "}
