...
- RLS on every tenant table; allow/deny matrix of 105 pgTAP assertions (`./scripts/test-rls.sh`).
- Immutability policies for terms acceptances / audit events (`supabase/tests/03_immutability.sql`).
